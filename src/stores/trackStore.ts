...
export const useTrackStore = defineStore('track', () => {
  ...
  const exportedJSON = computed(() => {
    ...
    const exportData = {
      _comment: 'This work (or portions thereof) incorporates data structures originally generated by PRTS, licensed under GPLv3. See https://github.com/leostudiooo/PRTS',
